<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="FreshFruity.Admin.Product" %>
                                        ...
                                        <div>
                                            ...
                                            <div class="pb-5">
                                                <asp:Button ID="btnAddOrUpdate" runat="server" Text="Add" CssClass="btn btn-primary"
                                                 ...
                                                 &nbsp
                                                <asp:Button ID="btnClass" runat="server" Text="Clear" CssClass="btn btn-primary"
                                                    CausesValidation="false" OnClick="btnClass_Click"/>
                                            </div>
                                        </div>                                         
                                      ...
                                      <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                          ...
                                          <ItemTemplate>
                                              <tr>
                                                  ...
                                                  <td>
                                                      <img alt="" width="40" src="<%# Utils.GetImageUrl( Eval("ImagUrl"))%>"/>
                                                  </td>
