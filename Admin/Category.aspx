<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="FreshFruity.Admin.Category" %>
                                            ...
                                            <div>
                                                ...
                                                <div class="pb-5">
                                                    ...
                                                    <asp:Button ID="btnClass" runat="server" Text="Clear" CssClass="btn btn-primary"
                                                        CausesValidation="false" OnClick="btnClick_Click" />
                                                </div>
                                            </div>                                         
